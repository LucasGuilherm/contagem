...
export function Visor() {
  return (
    <div className="bg-gray-200 h-auto w-full grid gap-1 p-1 grid-cols-4 grid-rows-3 grid-flow-row">
      ...
      <ItemVisor largura={"col-span-4"} label="Produto" valor="Leite" />
      <ItemVisor largura={"col-span-2"} label="Qtde" valor="10" />
      <ItemVisor largura={"col-span-2"} label="Qtde Ant" valor="3" />
    </div>
  );
}
